...
class InstructorUser(HttpUser):
    ...
    task_weights = [
        ENROLL_ONE_STUDENT_WEIGHT_FIRST,
        EXPEL_ONE_STUDENT_WEIGHT_FIRST,
        EDIT_ONE_COURSE_DESCRIPTION_WEIGHT_FIRST,
        UPLOAD_ONE_IMAGE_TO_COURSE_DESCRIPTION_WEIGHT_FIRST,
        UPLOAD_ONE_ATTACHMENT_TO_COURSE_DESCRIPTION_WEIGHT_FIRST,
        EDIT_ONE_COURSE_CONTENT_WEIGHT_FIRST,
        UPLOAD_ONE_IMAGE_TO_COURSE_CONTENT_WEIGHT_FIRST,
        UPLOAD_ONE_ATTACHMENT_TO_COURSE_CONTENT_WEIGHT_FIRST,
    ]
...
class StudentUser(HttpUser):
    ...
    task_weights = [
        VISIT_MY_COURSES_WEIGHT_FIRST,
        VISIT_ONE_COURSE_WEIGHT_FIRST,
        START_ONE_COURSE_WEIGHT_FIRST,
        FINISH_ONE_COURSE_WEIGHT_FIRST,
        REVIEW_ONE_COURSE_WEIGHT_FIRST,
    ]
    ...
    def tick(self):
        ...
        for stage in self.stages:
            if run_time < stage["duration"]:
                if run_time >= self.ENROLL_DDL and not self.enroll_ddl_remind:
