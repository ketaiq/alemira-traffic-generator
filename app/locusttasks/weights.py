...
def generate_tasks(day: Day, user: User) -> list:
    INSTRUCTOR_TASK_WEIGHT_FIRST_STAGE = {
        ...
        "upload_one_image_to_course_description": 2,
        "upload_one_attachment_to_course_description": 2,
        "edit_one_course_content": 20,
        "upload_one_image_to_course_content": 1,
        "upload_one_attachment_to_course_content": 1,
    }
    INSTRUCTOR_TASK_WEIGHT_SECOND_STAGE = {
        "enroll_one_student": 1,
        "expel_one_student": 1,
        "edit_one_course_description": 20,
        "upload_one_image_to_course_description": 1,
        "upload_one_attachment_to_course_description": 1,
        "edit_one_course_content": 100,
        "upload_one_image_to_course_content": 3,
        "upload_one_attachment_to_course_content": 3,
    }
