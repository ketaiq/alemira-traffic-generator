...
def test_get_attachment_url():
    ...
    assert (
        ...
        == "https://alms.crab.alemira.com/fileapi/api/v1/objectives/70394b91-d555-43ca-91a5-0424c7d25e73/protected-files/220503_news_review_plastic_blood.pdf"
    )
